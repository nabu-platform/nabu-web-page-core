			...
			<div class="is-row">
				<div class="is-column is-width-fixed-3 is-column is-align-cross-center is-align-main-start is-page-editing-small-menu is-spacing-gap-small">
					<div class="is-column is-spacing-vertical-medium is-spacing-gap-small">
						...
						<button class="is-button is-size-small has-tooltip" @click="save"><icon name="save"/><span class="is-tooltip">Last saved: {{saved ? $services.formatter.date(saved, 'HH:mm:ss') : 'never' }}</span></button>
					</div>
					<div class="is-column is-spacing-vertical-medium is-spacing-gap-small">
						<button class="is-button is-size-small has-tooltip" @click="activeTab = 'layout'" :class="{'is-active': activeTab == 'layout'}"><icon name="align-left"/><span class="is-tooltip">Layout</span></button>
						<button class="is-button is-size-small has-tooltip" @click="activeTab = 'settings'" :class="{'is-active': activeTab == 'settings'}"><icon name="cog"/><span class="is-tooltip">Page Settings</span></button>
						...
						<button :disabled="cell == null && row == null" class="is-button is-size-small has-tooltip" @click="activeTab = 'selected'" :class="{'is-active': activeTab == 'selected'}"><icon name="cube"/><span v-if="cell != null || row != null" class="is-tooltip">{{$services.page.formatPageItem($self, selectedType == 'cell' ? cell : row)}}</span><span v-else class="is-tooltip">Select an component on the page</span></button>
					</div>
					<div class="is-column is-spacing-vertical-medium is-spacing-gap-small">
						<button class="is-button is-size-small has-tooltip" @click="stopEdit(); $services.router.route('pages')"><icon name="file"/><span class="is-tooltip">View all pages</span></button>
				...
				<div v-show="!collapsedMenu" class="is-column is-fill-normal menu-content">
					<div class="is-row is-spacing-vertical-small is-spacing-medium is-spacing-gap-xsmall is-wrap-wrap breadcrumbs" v-if="selectedItemPath.length">
					...
					<div v-else-if="activeTab == 'selected' && cell && selectedType == 'cell'" :key="'page_' + pageInstanceId + '_cell_' + cell.id + '_configuration'">
						<div class="tabbed-menu is-row is-spacing-small is-spacing-vertical-bottom-none">
							<button @click="activeSubTab = 'component'" v-if="cell" :disabled="!canConfigureInline(cell)" class="is-button is-size-xsmall" :class="{'is-active': activeSubTab == 'component'}">Configuration</button>
							<button @click="activeSubTab = 'container'" class="is-button is-size-xsmall" :class="{'is-active': activeSubTab == 'container'}">Container</button>
							<button @click="activeSubTab = 'styling'" class="is-button is-size-xsmall" :class="{'is-active': activeSubTab == 'styling'}">Styling</button>
							<button @click="activeSubTab = 'triggers'" class="is-button is-size-xsmall" :class="{'is-active': activeSubTab == 'triggers'}">Triggers</button>
						</div>
						<n-form class="is-variant-floating-labels is-small" key="cell-form">
