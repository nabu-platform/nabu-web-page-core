...
nabu.page.imageComponentConstructer = function(name) {
	return Vue.component(name, {
		...
		activate: function(done) {
			...
			if (this.edit && name == "page-image-configure") {
		...
		created: function() {
			...
			// currently, configuration elements are components without an activate sequence!
			if (this.edit && name == "page-image-configure") {
				this.load();
			}
		},
		...
		methods: {
			...
			normalize: function(state) {
				...
				if (!state.height && !state.hasOwnProperty("height")) {
...
nabu.page.views.Image = nabu.page.imageComponentConstructer("page-image");
nabu.page.imageComponentConstructer("page-image-configure");