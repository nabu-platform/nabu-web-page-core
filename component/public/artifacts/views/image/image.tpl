			...
			<n-form class="layout2">
				<n-form-section>
					...
					<n-collapsible title="Image Content" class="images">
						...
						<div class="image-container" v-for="image in images" :class="{'selected': image.path == cell.state.href }" @click="cell.state.href = image.path">
							<div class="image"
								:title="image.path"
								:style="{'background-image': 'url(${server.root()}' + image.path + ')', height: '10rem', 'background-size': 'cover', width:'15rem' }"></div>
